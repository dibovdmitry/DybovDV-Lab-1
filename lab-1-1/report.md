...
Практическая часть
Выполненные задачи
[x] Установить Ubuntu 24.04.03 LTS в VirtualBox и подготовить среду для Docker.

[x] Установить Miniconda, создать и активировать виртуальное окружение mlops-lab.

[x] Установить пакеты pandas, scikit-learn, matplotlib, jupyterlab и проверить импорт.

[x] Установить Docker Engine: добавить GPG-ключ, настроить репозиторий, установить engine.

[x] Запустить тестовый Docker-образ и обучиться базовым командам: ps, ps -a, images, rm.

[x] Запустить JupyterLab в Docker-контейнере и проверить доступ по http://127.0.0.1:9999.
